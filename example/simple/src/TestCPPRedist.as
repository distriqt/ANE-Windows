...
package
{
	...
	/**	
	 * Sample application for using the CPPRedist Native Extension
	 */
	public class TestCPPRedist extends Sprite
	{
		...
		private function init( ):void
		{
			try
			{
				message( "CPPRedist Supported: " + CPPRedist.isSupported );
				message( "CPPRedist Version:   " + CPPRedist.service.version );
